          ...
          <ContentStyle>
            <m.div variants={varFade().inRight}>
              <Typography variant="h1" sx={{ color: 'common.white' }}>
                ...
                <Typography className="pl-5" component="span" variant="h1" sx={{ color: 'primary.main' }}>
                <br></br>
                <br/>{"  "} "The way it's supposed to be"
                </Typography>
              </Typography>
            </m.div>
            ...
            <m.div variants={varFade().inRight}>
              <Button
                ...
                startIcon={<Iconify icon={'fa-solid:search-dollar'} width={20} height={20} />}
              >
                Get a Quote!
              </Button>
            </m.div>
